...
<template>
  <div>
    ...
    class="
      ...
      class="bg-black hover:bg-[#282828] rounded-full p-0.5 mr-8 mt-05 cursor-pointer"
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://yt3.ggpht.com/yti/ADpuP3P-OzHoQ9qG53_Th_J2Az8HMAy3Bm5NEmU7AgA0xA=s88-c-k-c0x00ffffff-no-rj"
            >
            <div class="text-white text-[14px] ml-1.5 font-semibold">Marzooq Arib Husain</div>
