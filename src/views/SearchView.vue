...
<template>
   <div class="p-8">
        ...
        >
            Podcasts to make you smart smarter
    </button>
    ...
    <div class="grid xl :grid-cols-5 lg-grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6">
        ...
        <CategorySelect category="Made For You" image="https://picsum.photos/id/46/300/300"/>
        <!-- Can add more categories to appear in search screen. -->
    </div>
    </div>
</template>